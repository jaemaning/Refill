      ...
      <Box>
        <StyleContainer>
          <Header>
            ...
            <Typography id="modal-modal-title" variant="h6" component="h2" sx={{fontWeight: '700', justifySelf: 'left', minWidth: '400px'}}>
              현재 상담이 진행 중입니다. 상담을 종료 하시겠습니까?
            </Typography>
            <CloseIcon onClick={props.onClose} sx={{cursor: 'pointer'}} fontSize='large' />
          </Header>
          <Main>
            * 상담 진행중 상담을 일방적으로 종료시 추후 서비스 이용에 어려움이 있을 수 있습니다.
          </Main>
          <Footer>
