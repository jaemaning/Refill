...
const HospitalDetailModal: React.FC<HospitalDetailModalProps> = ({ hospital, onClose }) => {
    return (
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="relative bg-white p-8 rounded-lg shadow-lg z-10"> {/* relative를 추가하여 자식 요소를 절대 위치로 배치할 수 있게 함 */}
          {/* 닫기 버튼 */}
          ...
          <img src={hospital.hospitalProfileImg} alt="Hospital Profile" className="w-32 mt-4"/>
