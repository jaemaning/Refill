  ...
  useEffect(() => {
    ...
    axios
      .get("api/v1/hospital/1", {
        headers: {
          Authorization: `Bearer eyJhbGciOiJIUzI1NiJ9.eyJsb2dpbklkIjoibWVtYmVyMSIsInJvbGUiOiJST0xFX01FTUJFUiIsImlhdCI6MTY5MTIyMDI3OSwiZXhwIjoxNjkxMjIzODc5fQ.SyDcj2_YkmGti-T39MDhG3b4ODYNUQyZfQtXMMtQXms`,
        },
      })
