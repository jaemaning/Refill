...
public class ExceptionControllerAdvice {
    ...
    public ResponseEntity<ApiErrorResponse> aiDiagnosisExceptionHandler(AiDiagnosisException e) {
        log.error("MemberException occurred: '{}'", e.getMessage(), e);
        return ResponseEntity.status(e.getErrorCode().getHttpStatus())
                             .body(new ApiErrorResponse(e.getErrorCode().getCode(), e.getErrorCode(), e.getErrorCode().getMessage()));
    }
    ...
    public ResponseEntity<ApiErrorResponse> reservationExceptionHandler(AiDiagnosisException e) {
        log.error("MemberException occurred: '{}'", e.getMessage(), e);
        return ResponseEntity.status(e.getErrorCode().getHttpStatus())
                             .body(new ApiErrorResponse(e.getErrorCode().getCode(), e.getErrorCode(), e.getErrorCode().getMessage()));
    }
